    ...
    return (
        <form onSubmit={handleSubmit} className="flex">
            ...
            <div>
                ...
                <input type="text" name="student-skill-level" onChange={handleInputChange} />
            </div>
            <div>
                <label>Skill Worked On:</label>
                <input type="text" name="skill-worked-on" onChange={handleInputChange} />
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" name="additional-notes" onChange={handleInputChange} />
            </div>
            <div>
                <input type="submit" />
            </div>
